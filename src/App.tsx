          ...
          <div className="text-center max-w-3xl mx-auto space-y-6 pt-8 z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                ...
                className="group inline-flex items-center gap-2 bg-white hover:bg-neutral-200 text-neutral-950 font-display text-xs font-bold tracking-widest uppercase px-8 py-4 rounded-full transition-all duration-200 cursor-pointer shadow-lg active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
              >
      ...
      <footer className="bg-neutral-950 border-t border-white/5 pt-16 pb-8 px-6 text-neutral-500">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs font-sans">
              <li><a href="#overview" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Overview</a></li>
              <li><a href="#technology" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Technology Core</a></li>
              <li><a href="#customizer" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Design Customizer</a></li>
              <li><a href="#specs" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Technical specs</a></li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Terms of Service</a>
            <a href="#" className="hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 rounded-sm">Privacy and Cookies</a>
          </div>
        </div>
      </footer>
