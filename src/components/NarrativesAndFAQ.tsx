            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex justify-between items-center px-6 py-5 text-left text-white font-display text-sm font-semibold tracking-wide hover:bg-neutral-950/40 focus-visible:outline-none focus-visible:bg-neutral-950/60 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-white/30 transition-colors cursor-pointer"
                >
